<?php
	...
	$usernameA = $_POST["userA"];
	$usernameB = $_POST["userB"];

	//Armo una sentencia para ver si existe ese usuario
	$queryCheck = "SELECT Username FROM `accounts` WHERE Username = ('".$usernameA."');";
	...
	if (mysqli_num_rows($result) != 1)
	{
		...
		$sendFriendRequest = "INSERT INTO `friendlist`(user1, user2, status) VALUES ('".$usernameA."','".$usernameB."',0)";
	...
	mysqli_query($con, $sendFriendRequest) or die ($con->error);
